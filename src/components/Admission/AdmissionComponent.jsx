...
const AdmissionComponent = observer(() => {
    ...
    const fechaInicio = "xxxxxx"; // TODO

    return(
        <div className="section admission" name="admission">
            <span className="title">Admisión</span>
            <span className="text"> 
                El periodo de admisión para el Curso 2022 se iniciará el {fechaInicio}.
            </span>
            <span className="text"> 
